	...
	<div class="top_bar">
		<div class="top_left">
			<h4 class="call_us">
				...
				<span><?php echo get_theme_mod('callus_btn_lable') ?>:</span> <a href="tel:<?php echo get_theme_mod('callus_details') ?>"><?php echo get_theme_mod('callus_details') ?><?php echo get_theme_mod('callus_details1') ?></a></h4>
			<h4>
				<?php

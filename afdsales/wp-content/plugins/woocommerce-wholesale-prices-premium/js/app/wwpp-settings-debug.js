jQuery(document).ready(function ($) {
  var $initialize_product_visibility_meta_btn = $(
      "#initialize-product-visibility-meta"
    ),
    ...
    wwppBackendAjaxServices
      ...
      .done(function (data, textStatus, jqXHR) {
        if (data.status == "success") {
          toastr.success(
            "",
            wwpp_settings_debug_var.success_initialize_visibility_meta_txt,
            { closeButton: true, showDuration: success_message_duration }
          );
        } else {
          toastr.error(
            "",
            wwpp_settings_debug_var.failed_initialize_visibility_meta_txt,
    ...
    wwppBackendAjaxServices
      ...
      .done(function (data, textStatus, jqXHR) {
        if (data.status == "success") {
          toastr.success(
            "",
            wwpp_settings_debug_var.success_force_fetch_update_data_txt,
            { closeButton: true, showDuration: success_message_duration }
          );
        } else {
          toastr.error(
            "",
            wwpp_settings_debug_var.failed_force_fetch_update_data_txt,
            { closeButton: true, showDuration: error_message_duration }
          );

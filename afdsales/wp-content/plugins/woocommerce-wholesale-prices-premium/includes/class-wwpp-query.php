...
if (!class_exists('WWPP_Query')) {
    ...
    class WWPP_Query
    {
        ...
        public function optimized_meta_query($only_show_wholesale_products, $user_wholesale_role, $args = array())
        {
            ...
            if ($wwpp_product_cache_option == 'yes' && !empty($wwpp_cached_products_ids)) {
                ...
                if ($restricted_products && $only_show_wholesale_products) {
                    ...
                    if ($wwpp_override_discount_per_user == 'yes') {
                        ...
                        if ($wwpp_product_cache_option == 'yes') {
            ...
            if (
                ...
                if (!empty($product_ids)) {
                    ...
                    $variation_ids = $wpdb->get_results("
                        ...
                        AND post_parent IN ( " . implode(',', $product_ids) . " ) ", ARRAY_A);
        ...
        public function wc_shortcode_products_query($query_args, $attributes, $type = '')
        {
            ...
            return in_array($type, $wc_product_shortcodes) ? $this->pre_get_posts_arg($query_args) : $query_args;
         ...
         * @return array
         */
        public function disregard_wholesale_products($user_wholesale_role)
        {
            ...
            if ($this->_wholesale_user_have_general_role_discount($user_wholesale_role)) {
                ...
                $disregard_products = array_unique(array_merge($disregard_category_discount_products, $disregard_products));

            }

            // Find categories with wholesale discount for this current user
            // Get all products under the category when "Disregard Wholesale Role Level Wholesale Discount" is enabled
            $disregard_category_and_general_discount_products = get_posts(
                array(
                    'post_type'      => 'product',
                    'post_status'    => 'publish',
                    'posts_per_page' => -1,
            ...
            $disregard_products = array_unique(array_merge($disregard_category_and_general_discount_products, $disregard_products));

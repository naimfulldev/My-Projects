...
<div class="wholesale-exclusive-variation-options-group options-group options_group"
    ...
    <header class="form-row form-row-full">
        <h4 style="font-size: 14px; margin: 10px 0;">
            <?php _e('Wholesale Exclusive Variation', 'woocommerce-wholesale-prices-premium');?></h4>
        <p style="margin:0; padding:0; line-height: 16px; font-style: italic; font-size: 13px;">
            <?php _e("Specify if this variation should be exclusive to wholesale roles. Leave empty to make it available to all.<br><br>", 'woocommerce-wholesale-prices-premium');?>
        </p>
    </header>

    <div class="form-row form-row-full" style="position: relative;">
        <select multiple name="<?php echo WWPP_PRODUCT_WHOLESALE_VISIBILITY_FILTER . '[' . $loop . '][]'; ?>"
            ...
            <option value="<?php echo $role_key; ?>"
                <?php echo in_array($role_key, $option_value) ? 'selected' : ''; ?>><?php echo $role['roleName']; ?>
            </option>
            <?php }?>
        </select>
    </div>
...
<div class="wholesale-minium-order-quantity-options-group options-group options_group"
    ...
    <header>
        <h3 style="font-size: 14px; margin: 10px 12px;">
            <?php _e('Parent Product Wholesale Minimum Order Quantity', 'woocommerce-wholesale-prices-premium');?></h3>
        <p style="margin:0; padding:0 12px; line-height: 16px; font-style: italic; font-size: 13px;">
            <?php _e('Customers can add multiple variations to the cart and if the sum of all these variations exceeds the minimum quantity value supplied here, they will be granted the wholesale pricing as per the wholesale price on each variation.', 'woocommerce-wholesale-prices-premium');?>
        </p>
    </header>
...
<div class="wholesale-order-quantity-step-options-group options-group options_group"
    ...
    <header>
        <h3 style="font-size: 14px; margin: 10px 12px;">
            <?php _e('Parent Product Wholesale Order Quantity Step', 'woocommerce-wholesale-prices-premium');?></h3>
        <p style="margin:0; padding:0 12px; line-height: 16px; font-style: italic; font-size: 13px;">
            <?php _e('Customers can add multiple variations to the cart and if the sum of all these variations is within the increments (step) multiplier specified, they will be granted the wholesale pricing as per the wholesale price on each variation. Min order qty above must be specified to enable this feature.', 'woocommerce-wholesale-prices-premium');?>
        </p>
    </header>
...
<div class="wholesale-minium-order-quantity-options-group options-group options_group"
    ...
    <header class="form-row form-row-full">
        <h4 style="font-size: 14px; margin: 10px 0;">
            <?php _e('Wholesale Minimum Order Quantity', 'woocommerce-wholesale-prices-premium');?></h4>
        <p style="margin:0; padding:0; line-height: 16px; font-style: italic; font-size: 13px;">
            <?php _e("Minimum number of items to be purchased in order to avail this product's wholesale price.<br/>Only applies to wholesale users.<br/><br/>Setting a step value below for the corresponding wholesale role will prevent the specific wholesale customer from adding to cart quantity of this product lower than the set minimum.", 'woocommerce-wholesale-prices-premium');?>
        </p>
    </header>
...
<div class="wholesale-order-quantity-step-options-group options-group options_group"
    ...
    <header class="form-row form-row-full">
        <h4 style="font-size: 14px; margin: 10px 0;">
            <?php _e('Wholesale Order Quantity Step', 'woocommerce-wholesale-prices-premium');?></h4>
        <p style="margin:0; padding:0; line-height: 16px; font-style: italic; font-size: 13px;">
            <?php _e("Order quantity step wholesale users are restricted to when purchasing this product.<br/>Only applies to wholesale users.<br/><br/>Minimum order quantity above for corresponding wholesale role must be set for this feature to take effect.", 'woocommerce-wholesale-prices-premium');?>
        </p>
    </header>
...
<option value="<?php echo $role_key; ?>_wholesale_min_order_qty">
    <?php echo sprintf(__('Set minimum order quantity (%1$s)', 'woocommerce-wholesale-prices-premium'), $role['roleName']); ?>
</option>
...
<option value="<?php echo $role_key; ?>_wholesale_order_qty_step">
    <?php echo sprintf(__('Set order quantity step (%1$s)', 'woocommerce-wholesale-prices-premium'), $role['roleName']); ?>
</option>

        ...
        public function product_category_add_custom_fields($taxonomy)
        {
            ...
            foreach ($all_registered_wholesale_roles as $role_key => $role) {?>
                ...
                <div class="form-field wholesale-discount-product-cat-level <?php echo $role_key; ?>-wholesale-discount-product-cat-level">
                    ...
                    <input type="number" name="term_meta[<?php echo $role_key; ?>_wholesale_discount]" id="term_meta[<?php echo $role_key; ?>_wholesale_discount]" class="<?php echo $role_key ?>_wholesale_discount" value="" step="any">
                    <p class="description"><?php echo sprintf(__('%s Discount For Products In This Category. In Percent (&percnt;). Ex. 3 percent then input 3, 30 percent then input 30, 0.3 percent then input 0.3.', 'woocommerce-wholesale-prices-premium'), $role['roleName']); ?></p>
                </div>
        ...
        public function product_category_edit_custom_fields($term)
        {
            ...
            foreach ($all_registered_wholesale_roles as $role_key => $role) {
                ...
                <tr class="form-field wholesale-discount-product-cat-level <?php echo $role_key; ?>-wholesale-discount-product-cat-level">
                    ...
                    <td>
                        <input type="number" name="term_meta[<?php echo $role_key; ?>_wholesale_discount]" id="term_meta[<?php echo $role_key; ?>_wholesale_discount]" class="<?php echo $role_key ?>_wholesale_discount" value="<?php echo $discount; ?>" step="any" min="0">
                        <p class="description"><?php echo sprintf(__('%1$s Discount For Products In This Category. In Percent (&percnt;). Ex. 3 percent then input 3, 30 percent then input 30, 0.3 percent then input 0.3.', 'woocommerce-wholesale-prices-premium'), $role['roleName']); ?></p>
                    </td>
                </tr>
...
if (isset($all_registered_wholesale_roles[$mapping_data['wholesale-role']]['roleName'])) {
                    echo $all_registered_wholesale_roles[$mapping_data['wholesale-role']]['roleName'];
                } else {
                    echo sprintf(__('%1$s role does not exist anymore', 'woocommerce-wholesale-prices-premium'), $mapping_data['wholesale-role']);
                }
                    ?>
                                                </td>

    ...
    class WWPP_Cache
    {
        ...
        public function clear_product_transients_cache($transient_name = null)
        {
            ...
            if ($transient_name != null) {
                ...
                $results = $wpdb->get_results("SELECT option_name FROM $wpdb->options
                            WHERE option_name LIKE '_transient_wwpp_cached_products_ids%'", ARRAY_A);
        ...
        public function ajax_clear_product_transients_cache()
        {
            ...
            if (!defined("DOING_AJAX") || !DOING_AJAX) {
                ...
                $response = array('status' => 'success', 'success_msg' => __('Successfully cleared all products transients cache', 'woocommerce-wholesale-prices-premium'));
         ...
         *
         * @param int       $user_id
         * @param array     $user_cached_data
         * @access public
         */
        public function aelia_currency_compat($user_id, $user_cached_data = false)
        {

            $user_cache_key = 'wwpp_variable_product_price_range_cache';

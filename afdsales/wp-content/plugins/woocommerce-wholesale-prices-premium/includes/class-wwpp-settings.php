...
if (!class_exists('WWPP_Settings')) {
    ...
    class WWPP_Settings {
        ...
        public function plugin_settings_section_content($settings, $current_section) {
            ...
            } elseif ($current_section === 'wwpp_setting_upgrade_section') {
        ...
        public function save_editor_custom_field_type($settings) {
            ...
            if (isset($_GET['tab']) && isset($_GET['section']) && $_GET['tab'] == 'wwp_settings') {

                global $wc_wholesale_prices_premium;

                // If "Enable product ID caching" is enabled
                if ($_GET['section'] == 'wwpp_setting_cache_section' && isset($_POST['wwpp_enable_product_cache'])) {
        ...
        private function _get_general_section_settings() {
            ...
            return array(
                ...
                array(
                    ...
                    'type'     => 'radio',
                    'desc'     => 'Should the customer satisfy both or just one of the minimum order rules?',
                ...
                array(
                    'name' => __('Enforce Product Min/Step On Cart Page', 'woocommerce-wholesale-prices-premium'),
                    'type' => 'checkbox',
                    'desc' => __('This only works when both the minimum and steps are set in the product.', 'woocommerce-wholesale-prices-premium'),
        ...
        private function _get_discount_section_settings() {
            ...
            return array(
                ...
                array(
                    ...
                    'type' => 'title',
                    'desc' => __('Optionally give an additional discount for specific wholesale roles based on the cart subtotal price (excluding taxes & shipping). Discounts are shown in the totals table and are applied to the entire order.<br/><br/>
                                ...
                                You can tier additional discounts by adding extra subtotal price breakpoints. Only one discount will apply.', 'woocommerce-wholesale-prices-premium'),
        ...
        public function remove_settings_params($tabs) {
            ...
            if (isset($_GET['tab']) && $_GET['tab'] == 'wwp_settings' &&

...
if (!class_exists('WWPP_Script_Loader')) {
    ...
    class WWPP_Script_Loader
    {
        ...
        public function load_back_end_styles_and_scripts($handle)
        {
            ...
            if (strcasecmp($this->_rtl_string($handle), $this->_wwpp_roles_page_handle) == 0) {
            ...
            if ($handle == 'product_page_addons' || (($handle == 'post-new.php' || $handle == 'post.php') && $post_type == 'product')) {
            ...
            if (($handle == 'post-new.php' || $handle == 'post.php') && $post_type == 'product') {
                ...
                wp_localize_script('wwpp_single_product_admin_js', 'wwpp_single_product_admin_vars', array(
            ...
            if (isset($_GET['page']) && $_GET['page'] == 'wc-settings' &&
                ...
                wp_localize_script('wwpp_cart_subtotal_price_based_discount_js', 'cart_subtotal_price_based_discount_params', array(
                    'i18n_please_specify_wholesale_role' => __('Please specify wholesale role', 'woocommerce-wholesale-prices-premium'),
            ...
            // WWS Upsell Content in Settings Page
            if ($screen->id === 'woocommerce_page_wc-settings' && isset($_GET['section']) && $_GET['section'] === 'wwpp_setting_upgrade_section') {
                ...
                if ($post->post_type == 'product') {
                    ...
                    if (WWP_Helper_Functions::wwp_get_product_type($product) == 'variable') {
                        ...
                        if (!empty($userWholesaleRole)) {
                             ...
                             */
                            if (get_user_meta(get_current_user_id(), 'wwpp_override_wholesale_discount', true) == 'yes') {
                                ...
                                if (!empty($wholesale_role_discount)) {
                                    ...
                                    if (!empty($cart_qty_discount_mapping) && !$has_per_user_wholesale_discount_quantity_mapping) {
                                        ...
                                        foreach ($cart_qty_discount_mapping as $qty_mapping) {
                                            ...
                                            if (in_array($qty_mapping['wholesale_role'], $userWholesaleRole) && !$has_per_user_wholesale_discount_quantity_mapping) {
                            ...
                            } else if (get_option('enable_wholesale_role_cart_quantity_based_wholesale_discount') == 'yes') {
                                ...
                                if (array_key_exists($userWholesaleRole[0], $wholesale_role_discount)) {
                                    ...
                                    if (!empty($cart_qty_discount_mapping) && !$has_per_general_wholesale_discount_quantity_mapping) {
                                        ...
                                        foreach ($cart_qty_discount_mapping as $qty_mapping) {
                                            ...
                                            if (in_array($qty_mapping['wholesale_role'], $userWholesaleRole) && !$has_per_general_wholesale_discount_quantity_mapping) {
         ...
         * @since 1.26.3
         * @access private
         * @param string $string_to_replace, $char, $replace_with
         * @return string
         */

...
if (!class_exists('WWLC_Upgrade_Account')) {
    ...
    class WWLC_Upgrade_Account {
         ...
         * @return array
         */
        public function upgrade_account($user_data, $email_processor, $auto_generated_password, $password) {
            ...
            if (in_array('customer', $user_roles) && $account_upgrade === 'yes') {
                ...
                $this->_wwlc_user_account->auto_approve_new_leads($user_data, $email_processor, $new_lead, $password);
        ...
        public function run() {
            ...
            add_action('wwlc_action_before_create_user', array($this, 'upgrade_account'), 10, 4);

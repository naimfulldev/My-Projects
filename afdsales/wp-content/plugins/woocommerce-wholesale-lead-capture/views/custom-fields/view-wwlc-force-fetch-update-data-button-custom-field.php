...
<tr valign="top">
    ...
    <td class="forminp forminp-force_fetch_update_data_button">
        <input type="button" id="wwlc-force-fetch-update-data" class="button button-secondary" value="<?php _e('Refetch Plugin Update Data', 'woocommerce-wholesale-lead-capture');?>" data-confirm="<?php _e('Are you sure you want to refetch plugin update data?', 'woocommerce-wholesale-lead-capture');?>"><span class="spinner"></span>

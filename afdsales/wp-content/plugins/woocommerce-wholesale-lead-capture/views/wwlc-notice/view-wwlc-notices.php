<?php if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly 
    ...
    $wwlc_getting_started_link  = 'https://wholesalesuiteplugin.com/kb/woocommerce-wholesale-lead-capture-getting-started-guide/?utm_source=wwlc&utm_medium=kb&utm_campaign=wwlcgettingstarted';
        ...
        if( $screen->id === 'settings_page_wwc_license_settings' || $screen->post_type === 'product' || in_array( $screen->parent_base , array( 'woocommerce' , 'plugins' ) ) ) { 
            ...
            if( $active_counter > 1 ) { ?>
                ...
                <div class="updated notice wwlc-getting-started">
                    <p><img src="<?php echo WWLC_IMAGES_ROOT_URL; ?>wholesale-suite-activation-notice-logo.png" alt=""/></p>
